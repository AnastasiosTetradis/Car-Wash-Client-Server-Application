...
public class ServiceDB {
    ...
    private Set<Vehicle> data = new LinkedHashSet<>();
    ...
    public void setAllVehicles(Set<Vehicle> data){
        this.data = data;
    }
    ...
    public Service getSpecificService(String vehicleType, String groupName, String serviceName){
        Vehicle vehicle = getVehicleByName(vehicleType);
        if(vehicle != null){
            Iterator<ServiceGroup> groupIt = vehicle.getServiceGroupList().iterator();
            while(groupIt.hasNext()){
                ServiceGroup currentGroup = groupIt.next();
                if(currentGroup.getGroupName().equals(groupName)){
                    Iterator<Service> serviceIt = currentGroup.getServices().iterator();
                    while(serviceIt.hasNext()){
                        Service currentService = serviceIt.next();
        ...
        // Service, Group or Vehicle with given name not found
        return null;
    }
